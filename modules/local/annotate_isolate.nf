 ...
 workflow ANNOTATE_ISOLATES{
    ...
    main:
        ...
        if(annotate){
            ...
            blastx_txts = DIAMOND_BLASTX.out.txt
        }
        profiles_ch = Channel.empty()
		if(profile){
            ...
            profiles_ch = PROFILE_FINDER.out  
		}
    ...
    emit:
       ...
       diamond_txt = blastx_txts
       seqtypes = profiles_ch
